...
public class ArqueoCobranzasView extends javax.swing.JInternalFrame {
    ...
    public ArqueoCobranzasView() {
        ...
        jasperRunnerButton1.setVisible(false);
    ...
    private void buscarRecibos() {
        ...
        if (cbSituacion.getSelectedItem().toString().equals("Todos")) {
            listMensualidades.addAll(mensualidadesDAO.BuscaPorVencimiento(dpDesde.getDate(), dpHasta.getDate()));
        } else {
            Boolean situacion;
            if (cbSituacion.getSelectedItem().toString().equals("Pago")) {
                situacion = true;
            } else {
                situacion = false;
            }
            listMensualidades.addAll(mensualidadesDAO.BuscaPorSituacionVencimiento(situacion, dpDesde.getDate(), dpHasta.getDate()));
        }
