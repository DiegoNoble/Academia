...
import com.club.BEANS.SituacionArticuloEnum;
...
public class ArticulosFrame extends javax.swing.JInternalFrame {
    ...
    private RegistraVenta registraVenta;
    ...
    public ArticulosFrame(RegistraVenta registraVenta) {
        initComponents();
        this.registraVenta = registraVenta;
    ...
    public final void actualizaCbCategoria() {
        ...
        try {
            ...
            List<CategoriaArticulo> listadeCategorias = new ArrayList();

            daoGenerico = new DaoGenerico();
            listadeCategorias = daoGenerico.BuscaTodos(CategoriaArticulo.class);

            cbCategoria.removeAllItems();

            for (CategoriaArticulo categorias : listadeCategorias) {
    ...
    public final void actualizaCbUnidad() {
        ...
        try {
            ...
            daoGenerico = new DaoGenerico();
            listaUnidad = daoGenerico.BuscaTodos(Unidad.class);
    ...
    /* private void seleccionaArticulo() {
        ...
        if (registraVenta != null) {
            registraVenta.agregarArticuloPedido(articuloSeleccionado);
        } else if (registraVenta != null) {
            registraVenta.agregarArticuloPedido(articuloSeleccionado);
        ...
        if (txtNombre.getText().trim().equals("")) {
            ...
            try {
                ...
                if (chActivo.isSelected()) {
                    articulo.setActivo(SituacionArticuloEnum.ACTIVO);
                } else {
                    articulo.setActivo(SituacionArticuloEnum.INACTIVO);
                }
                ...
                articulo.setCategoriaArticulo((CategoriaArticulo) cbCategoria.getSelectedItem());
    ...
    private void EditarProducto() {
        ...
        if (txtNombre.getText().trim().equals("")) {
            ...
            try {
                ...
                Logger.getLogger(ArticulosFrame.class.getName()).log(Level.SEVERE, null, ex);
            }
        ...
        try {
            ...
            if (rbCodigo.isSelected()) {
                ...
                if (txtFiltro.getText().equals("")) {
                    ...
                    listArticulos.clear();
                    listArticulos.addAll(articuloDAO.BuscaPor(Articulo.class, "id", txtFiltro.getText()));
                    tableModelArticulos.fireTableDataChanged();
                }

            } else if (rbNombre.isSelected()) {
                listArticulos.clear();
                listArticulos.addAll(articuloDAO.BuscaPor(Articulo.class, "nombre", txtFiltro.getText()));
                tableModelArticulos.fireTableDataChanged();

            } else if (rbDescripcion.isSelected() == true) {
                listArticulos.clear();
                listArticulos.addAll(articuloDAO.BuscaPor(Articulo.class, "descripcion", txtFiltro.getText()));
                tableModelArticulos.fireTableDataChanged();
            }
    ...
    private void eliminaProducto() {
        ...
        daoGenerico = new DaoGenerico();
        daoGenerico.elminiar(Articulo.class, articulo);
    ...
    public void detallesArticulos() {
        ...
        if (articuloSeleccionado != null) {
            try {
                ...
                cbCategoria.setSelectedItem(articuloSeleccionado.getCategoriaArticulo());
    ...
    private void initComponents() {
        ...
        jlbCodigo.setText("Código do artigo");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.LINE_END;
        ...
        jLabel6.setText("Valor Venda (Imp. Incl.)");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 2;
        ...
        jLabel20.setText("Menor Unidades");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 0;
        gridBagConstraints.gridy = 0;
        ...
        btnSeleccionaArticuloVenta.setText("Selecciona artigo");
        ...
        rbDescripcion.setText("Descrição");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 3;
        gridBagConstraints.gridy = 0;
        ...
        chActivos.setText("Ver inativos");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 4;
        gridBagConstraints.gridy = 0;
        ...
        jToggleButton1.setText("Detalhes");
